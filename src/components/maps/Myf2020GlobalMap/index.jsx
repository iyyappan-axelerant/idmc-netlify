...
export const Myf2020GlobalMap = ({ data }) => {
  ...
  const setWindowParams = useCallback(() => {
    ...
    mapjsTag.src = withPrefix("maps/myf2020.js");
  ...
  return (
    <>
      ...
      <Container className="myf2020-globalmap-container">
        <Row>
          <div class="wow zoomIn container" align="center">
            ...
            <div className="second-wrapper">
              <embed
                type="image/svg+xml"
                src="/maps/assets/globalmap2020.svg?v=2"
                width="100%"
                height="700"
              />
